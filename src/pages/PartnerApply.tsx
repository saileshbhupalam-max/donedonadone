...
export default function PartnerApply() {
  usePageTitle("Partner Application — DanaDone");
  const { user } = useAuth();
  ...
  return (
    <AppShell>
      <div className="px-4 py-4 max-w-lg mx-auto space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Join DanaDone as a partner venue and attract focused professionals to your space.</p>
