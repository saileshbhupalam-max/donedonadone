...
export default function Partners() {
  usePageTitle("Partner Venues — DanaDone");
    ...
    <AppShell>
      <div className="px-4 py-4 space-y-6 max-w-lg mx-auto">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Great cafes and coworking spaces where DanaDone sessions happen</p>
        </div>
        ...
        <Card className="border-primary/20">
          <CardContent className="p-6 text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">Partner with DanaDone and get focused professionals visiting your space regularly.</p>
            <Button className="gap-2" onClick={() => window.open("https://wa.me/919876543210?text=Hi! I'd like to partner my venue with DanaDone.", "_blank")}>
